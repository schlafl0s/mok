...
export default function Specials ({ setPopupOpen }) {
    ...
    const nextSlide = () => {
        setCurrentTransition((prevTransition) => {
            const newSlide = (currentPage !== slide.length - 1) ? currentSlide + 1 : 0
            const newTransition = (currentPage !== slides.length - 1) ? prevTransition - 100 : 0
        ...
        <section className={s.specials}>
            <div className={s.specialsUp}>
                ...
                <div className={s.switcher}>
                    ...
                    <button onClick={nextSlide} className={s.switchBtnRight}>
            ...
            <div className={s.specialsBlocks} style={{ transform: `translateX(${currentTransition}%)`}}>
